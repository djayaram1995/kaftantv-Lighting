import LiveSliderItem from "./LiveSliderItem.js/index.js";

export default class LiveSlider extends lng.Component {
    static _template(){
        return {
            alpha: 0.5,
            Title:{
    ...
    set data(v){
        ...
        if(title != ""){
            this.patch({
                ...
                Items:{
                    children: contentInfo.map((item, idx)=>{
            ...
            class Expanded extends this{
                $enter(){
                    ...
                    this.items.forEach((item, idx)=>{
                        item.patch({
                            smooth:{
                                x: [idx * 400, {duration:0.3, delay:idx*0.04}],
                                scale: 1
                            }
                        });
                    });
